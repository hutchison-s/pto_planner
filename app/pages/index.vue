...
const headerTitle = computed(() => hasInitialSetup.value ? currentMonthLabel.value : 'Set up PTO')
const headerSubtitle = computed(() =>
  hasInitialSetup.value ? `Balance ${formatHours(currentBalance.value)}h` : 'Initial balance needed'
)
